...
import {
  ...
  useGetBookProviders,
  useGetAuthorProviders,
  useDeleteAuthorsProviders,
  useUpdateAuthorsProviders,
} from "@/hooks";
import {
  PlainUserModel,
  UserUpdateModel,
...
const AuthorsDetailsPage: FC = () => {
  ...
  function getBookOwners(
    authorToShow: PlainBookModel,
            ...
            <ul className="flex space-x-2">
              ...
              <li>
                <p className=" text-xl font-bold transition duration-500 ease-in-out ">
                  {authorToShow
                    ? `${authorToShow.firstName} ${authorToShow.lastName}`
                    : "No author"}
                </p>
              </li>
            </ul>
        ...
        {authorToShow && (
          <>
            ...
            <div className="px-8 py-4">
              ...
              {findBookWritten(books).length > 0 &&
                findBookWritten(books).map((book) => (
                  <div
                    className="relative inline-block bg-blue-200 text-blue-800 px-2 py-1 rounded m-1"
                    key={book.id}
                  >
                    <div className="flex">
                          ...
                          <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                              <h3
                                ...
                                id="modal-title"
                              >
                                Modify {authorToShow.firstName}{" "}
                                {authorToShow.lastName}
                              </h3>
                              <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                  Be sure to enter the good informations about
                                  the author you're about to modify.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="sm:flex sm:items-start">
                            ...
                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                              ...
                              <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                  Be sure to enter the good informations about
                                  the author you're about to add.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <form onSubmit={handleAddBook}>
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                              <div className="sm:col-span-4">
                                ...
                                <div className="mt-2">
                                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    <span className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                      {authorToShow.firstName}{" "}
                                      {authorToShow.lastName}
                                    </span>
                                  </div>
                                </div>
                        ...
                        <div className="sm:col-span-4">
                          ...
                          <div className="mt-2">
                            <select
                              ...
                              onChange={(e) =>
                                setSelectedBookToDelete(e.target.value)
                              }
                              className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                            >
