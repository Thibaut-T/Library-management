...
const RegisterForm = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto mt-8">
      {isSubmitted ? (
        <Link href="/">
          <button className="group relative w-1/2 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 mx-auto">
            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 3a7 7 0 00-4.95 11.95l4.95-4.95v3.05A3.5 3.5 0 0114.5 14l4.95-4.95A7 7 0 0010 3z"
                  clipRule="evenodd"
                />
              </svg>
            </span>
        ...
        <form
          ...
          className="bg-white shadow-md rounded px-8 pt-6 rounded-xl pb-8 mb-4"
        >
